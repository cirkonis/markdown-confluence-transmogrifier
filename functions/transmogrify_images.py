...
# #     """
# #     # Regex to find all Markdown image patterns in the line
...
# #         absolute_image_path = os.path.normpath(os.path.join(config.DOCUMENTATION_IMAGE_DIRECTORY, image_path))
# #
# #         if os.path.exists(absolute_image_path):
# #             files_to_upload.append(absolute_image_path)
# #
...
# #         else:
# #             logging.error(f"File: {absolute_image_path} not found. Nothing to attach")
# #
